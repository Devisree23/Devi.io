		...
		<div class="align">
			<div class="body-content-color">
				<form action="EditMovies" onsubmit="return validateMoviesForm()"
					...
					<br> <br>
					<div class="form-field-spacing">
						<label for="teaser"></label>Has Teaser <input type="checkbox"
							name="teaser" id="" <c:if test="${movies.teaser}">checked</c:if>>
					</div>
					<br> <br>
					<div>
